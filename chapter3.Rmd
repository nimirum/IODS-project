...
cbind(OR, CI)
```
In here we can see that people with alcohol use are more likely to have high course failure count high chance of having absences. In odds ratio model the high alcohol students are more probably males than females. These results support my hypothesis.
